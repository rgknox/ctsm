module MLCLMCanopyNitrogenProfileMod
  ...
  subroutine CanopyNitrogenProfile (num_filter, filter, mlcanopy_inst)
    ...
    use MLCanopyVarCtl, only : acclim_type, kn_val
    use MLCanopyVarCon, only : isun, isha
...
end module MLCLMCanopyNitrogenProfileMod
